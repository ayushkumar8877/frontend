...
var TextComposer = class {
  constructor({ composer, message }) {
    ...
    this.setCommand = (command) => {
      var _a;
      if ((command == null ? void 0 : command.name) === ((_a = this.command) == null ? void 0 : _a.name)) return;
...
var _MessageComposer = class _MessageComposer2 extends WithSubscriptions {
  ...
  constructor({
    ...
    this.getDraft = async () => {
      ...
      const draftFromOfflineDB = await ((_a = this.client.offlineDb) == null ? void 0 : _a.getDraft({
        cid: this.channel.cid,
...
var Channel = class {
  ...
  async query(options = {}, messageSetToAddToIfDoesNotExist = "current") {
    ...
    (_g = this.getClient().offlineDb) == null ? void 0 : _g.executeQuerySafely(
      (db) => {
        var _a2;
    ...
    switch (event.type) {
      ...
      case "member.updated": {
        ...
        if (memberCopy == null ? void 0 : memberCopy.user) {
          ...
          if (((_l = channel.data) == null ? void 0 : _l.member_count) && event.type === "member.added") {
            channel.data.member_count += 1;
          }
        }
        const currentUserId = this.getClient().userID;
        if (typeof currentUserId === "string" && typeof ((_m = memberCopy == null ? void 0 : memberCopy.user) == null ? void 0 : _m.id) === "string" && memberCopy.user.id === currentUserId) {
          channelState.membership = memberCopy;
        }
        break;
      }
      case "member.removed":
        if ((_n = event.user) == null ? void 0 : _n.id) {
          const newMembers = {
            ...channelState.members
          };
          delete newMembers[event.user.id];
          channelState.members = newMembers;
          if ((_o = channel.data) == null ? void 0 : _o.member_count) {
            channel.data.member_count = Math.max(channel.data.member_count - 1, 0);
          }
        }
        break;
      case "notification.mark_unread": {
        const ownMessage = ((_p = event.user) == null ? void 0 : _p.id) === ((_q = this.getClient().user) == null ? void 0 : _q.id);
      ...
      case "channel.updated":
        if (event.channel) {
          const isFrozenChanged = ((_r = event.channel) == null ? void 0 : _r.frozen) !== void 0 && event.channel.frozen !== ((_s = channel.data) == null ? void 0 : _s.frozen);
          if (isFrozenChanged) {
            this.query({ state: false, messages: { limit: 0 }, watchers: { limit: 0 } });
          }
          const newChannelData = {
            ...event.channel,
            hidden: ((_t = event.channel) == null ? void 0 : _t.hidden) ?? ((_u = channel.data) == null ? void 0 : _u.hidden),
            own_capabilities: ((_v = event.channel) == null ? void 0 : _v.own_capabilities) ?? ((_w = channel.data) == null ? void 0 : _w.own_capabilities)
          };
      ...
      case "channel.visible":
        ...
        (_x = this.getClient().offlineDb) == null ? void 0 : _x.handleChannelVisibilityEvent({ event });
        break;
      case "user.banned":
        if (!((_y = event.user) == null ? void 0 : _y.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: !!event.shadow,
          banned: !event.shadow,
          user: { ...((_z = channelState.members[event.user.id]) == null ? void 0 : _z.user) || {}, ...event.user }
        };
        break;
      case "user.unbanned":
        if (!((_A = event.user) == null ? void 0 : _A.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: false,
          banned: false,
          user: { ...((_B = channelState.members[event.user.id]) == null ? void 0 : _B.user) || {}, ...event.user }
        };
        break;
      default:
    }
...
var StreamChat = class _StreamChat {
  ...
  async queryReactions(messageID, filter2, sort = [], options = {}) {
    ...
    if (((_a = this.offlineDb) == null ? void 0 : _a.getReactions) && !options.next) {
      try {
...
//# sourceMappingURL=chunk-PPBPUNTR.js.map
